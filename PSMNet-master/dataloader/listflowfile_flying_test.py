...
#  for l,r,d in zip(all_left_img,all_right_img,all_left_disp):
#   stri=[str(l).replace(filepath,'')+' ',str(r).replace(filepath,'')+' ',str(d).replace(filepath,'')+' ']
...
#   file.write('\n')
#  file.close()
#  print("len of right left disp",len(all_left_img),len(all_right_img),len(all_left_disp))
#  print("len of right left disp",len(test_left_img),len(test_right_img),len(test_left_disp))
...
def dataloader(filepath):  # /media/hugonie/Hhome/dataset/SceneFlowData/
    ...
    #test_left_img=train_test_split(all_left_img,test_size=0.1,random_state=42)
    #test_right_img=train_test_split(all_right_img,test_size=0.1,random_state=42)
    #test_left_disp=train_test_split(all_left_disp,test_size=0.1,random_state=42)
    ...
    # print("len of right left disp train",len(monkaa_train_left_img),len(monkaa_train_right_img),len(monkaa_train_left_disp))
    # print("len of right left disp test",len(monkaa_test_left_img),len(monkaa_test_right_img),len(monkaa_test_left_disp))
    ...
    for l,r,d in zip(test_left_img,test_right_img,test_left_disp):
        ...
        file.write('\n')
    file.close()
   # print("len of right left disp",len(train_left_img),len(train_right_img),len(train_left_disp))
